...
public class TMDBHelper {
    private static String apiKey = "35e3a62b4d3f69da7d3a732867d3e414";
    private static String baseUrl = "https://api.themoviedb.org/3/";
    private static String ApiKeyYoutube = "AIzaSyD0t9vi6ALG8BPiMZ8L_svyLklvWMYuhjs";
    ...
    public static String getApiKeyYoutube() {
